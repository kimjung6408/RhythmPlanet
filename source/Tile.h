...
//	XMFLOAT4 Ambient;
//public:
//	Tile(XMFLOAT3 Position, XMFLOAT2 Scale)
//	{
...
//		XMMATRIX ScaleMatrix = XMMatrixScaling(Scale.x, Scale.y, 1);
//		XMMATRIX RotMatrix = XMMatrixRotationRollPitchYaw(MathHelper::Pi / 2.0f, 0, 0);
