...
float4 PS(VertexOut pin) : SV_Target
{
	...
	float4 texColor=Texture.Sample(samLinear, pin.texCoord+UVOffset);
///*begin get Normal*/
...
//	/*end getNormal*/
	...
	float3 resultColor=lerp(diffuseColor.rgb, AmbientColor.rgb, AmbientColor.a-0.1f)*saturate(dot(pin.Normal,toLightVector));
